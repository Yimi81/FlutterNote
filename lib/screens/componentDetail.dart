 ...
 * @version: 
 * @Author: Yimi81
 * @Date: 2020-09-29 10:53:20
 * @LastEditors: Yimi81
 * @LastEditTime: 2020-09-29 14:03:08
 */
import 'dart:ui';
...
class ComponentDetail extends StatefulWidget {
  final User user;
  const ComponentDetail({Key key, this.user}) : super(key: key);
  @override
  _ComponentDetailState createState() => _ComponentDetailState();
}
...
class _ComponentDetailState extends State<ComponentDetail> {
  ...
  Widget makeFollowWigets({count, name}) {
    return Row(
      children: [
        Text(count.toString(),
            style: TextStyle(
